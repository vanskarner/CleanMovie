...
import com.vanskarner.remotedata.utils.TestMockWebServer;
...
public class MovieRemoteRxRepositoryTest {
    ...
    public void setUp() throws IOException {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                ...
                .addInterceptor(new RemoteErrorInterceptor(mockRemoteDataErrorFilter))
                .build();
    ...
    @Test(expected = RemoteError.NoInternet.class)
    ...
    @Test(expected = RemoteError.NotFound.class)
    ...
    @Test(expected = RemoteError.Server.class)
