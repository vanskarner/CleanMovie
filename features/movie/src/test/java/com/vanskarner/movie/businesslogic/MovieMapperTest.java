...
public class MovieMapperTest {
    ...
    public void convert_fromMovieDetailDS_toMovieBO() {
        ...
        assertEquals(expectedItem.basicDS.id, actualItem.getId());
        assertEquals(expectedItem.basicDS.title, actualItem.getTitle());
        assertEquals(expectedItem.basicDS.image, actualItem.getImage());
